 ...
 */
class Packlink_Magento1_Model_Shipment_Status extends Mage_Core_Model_Abstract
{

    public function _construct()
    {
        parent::_construct();
        $this->_init('packlink_magento1/shipment_status');
    }
    ...
    public function setStatus($shipmentId, $status, $message = '', $reference = '', $tracking = '')
    {
        ...
        $obj = Mage::getModel('packlink_magento1/shipment_status')->load($shipmentId, 'shipment_id');
